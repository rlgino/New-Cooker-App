        ...
        <IonContent>
            <form className="h-screen flex items-center form" onSubmit={e => createUser(e)}>
                <div className="flex flex-col items-center w-full">
                    ...
                    <button type="submit" className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                </div>
            </form>
        </IonContent>
    </IonPage>
