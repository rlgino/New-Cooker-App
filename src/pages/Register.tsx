    ...
    return <IonPage>
        ...
        <IonContent>
            <form className="max-w-md mx-auto form flex flex-col items-center w-full" onSubmit={e => createUser(e)}>
                ...
                <button type="submit" className="text-white bg-primary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-primary dark:focus:ring-primary">Create</button>
            </form>
        </IonContent>
    </IonPage>
}
