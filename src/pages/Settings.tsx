    ...
    return <IonPage>
        ...
        <IonContent>
            <form className="max-w-md mx-auto p-6" onSubmit={(e) => update(e)} >
                ...
                <button type="submit"
                    disabled={saving}
                    className="bg-primary bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">
